...
from flaskr.model import article_click, article_collect, article_views, register_login, user_message,upload_avatar,follow_fans,article_img,article_add,article_list,article_details
